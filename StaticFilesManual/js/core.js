...
{
    var pagearea = document.getElementById('DocsAnalyticsData').getAttribute("data-area");
    var pagetype = document.getElementById('DocsAnalyticsData').getAttribute("data-pagetype");
...
$(document).ready(function() {
  if (!("file:"==document.location.protocol))
  {
    ...
    // the problem types:
    // (problemFormDescription is a hidden field, sent to the bug report, but not displayed to user. user gets a localised version of this instead)


    // needs code
    $('#problemneedcode').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('Needs code samples');
        $('#problemNeedCodeForm').show();
        SendFeedback('problem-needcode',0);
    });

    // code (problem in existing code)
    $('#problemcode').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('Code samples do not work');
        $('#problemCodeForm').show();
        SendFeedback('problem-brokencode',0);
    });


    // missing information
    $('#problemmissing').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('Missing information');
        $('#problemMissingForm').show();
        SendFeedback('problem-missing',0);
    });


    // incorrect information
    $('#problemincorrect').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('Incorrect information');
        $('#problemIncorrectForm').show();
        SendFeedback('problem-incorrect',window.location.href,0);
    });


    // unclear
    $('#problemunclear').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('Unclear or confusing information');
        $('#problemUnclearForm').show();
        SendFeedback('problem-unclear',0);
    });


    // spelling or grammar (language)
    $('#problemlanguage').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('Spelling or grammar error');
        $('#problemLanguageForm').show();
        SendFeedback('problem-language',0);
    });


    // code (problem in existing code)
    $('#problemother').click( function(e) {
        $('#problemType').hide();
        $('#problemThanks').show();
        $('#problemFormDescription').text('This page has a problem');
        $('#problemOtherForm').show();
    ...
    $('#problemThanksMoreInfoButton').click( function(e) {
        $('#problemThanks').hide();
        $('#problemMoreInfo').show();
    });
    ...
    $('#problemFormDescriptionSubmit').click( function(e) {

        $("#problemMoreInfo").hide();
        $("#problemMoreInfoThanks").show();

        var submitURL = "https://bugservices.unity3d.com/docs/api/v1.0/feedback";

        var problemDescription = $("input#problemFormDescription").val();
        var page = window.location.href;
        var suggestion = $("textarea#problemFormSuggestionField").val();

        // we include the full url as an extra line in the suggestion, to make it easy
        // to open the link when viewing in fogbugz:
        suggestion += "\n\nURL: "+page;
        ...
        var postData = {
            "title":page+" "+version+": "+problemDescription,
